...
return [
    ...
    */
    ...
    'between' => [
        'array' => 'حقل :attribute يجب أن يحتوي على :min إلى :max عنصرًا.',
    ...
    'decimal' => 'حقل :attribute يجب أن يحتوي على :decimal عدد من الأماكن العشرية.',
    ...
    'in_array' => 'حقل :attribute يجب أن يكون في :other.',
    ...
    'lowercase' => 'حقل :attribute يجب أن يكون في حالة الأحرف الصغيرة.',
    'lt' => [
    ...
    'lte' => [
        ...
        'string' => 'حقل :attribute يجب أن يكون أقل من أو مساويًا لـ :value حرفًا.',
    ],
    ...
    'min' => [
        'array' => 'حقل :attribute يجب أن يحتوي على على الأقل :min عنصرًا.',
    ...
    'missing_unless' => 'حقل :attribute يجب أن يكون مفقودًا ما لم :other يكون في :value.',
    ...
    'not_regex' => 'حقل :attribute يحتوي على تنسيق غير صالح.',
    'numeric' => 'حقل :attribute يجب أن يكون رقمًا.',
    'password' => [
        'letters' => 'حقل :attribute يجب أن يحتوي على حرف واحد على الأقل.',
        'mixed' => 'حقل :attribute يجب أن يحتوي على حرف كبير وحرف صغير ورقم ورمز واحد على الأقل.',
    ...
    'uppercase' => 'حقل :attribute يجب أن يكون في حالة أحرف كبيرة.',
    'url' => 'حقل :attribute يجب أن يكون عنوان URL صحيحًا.',
