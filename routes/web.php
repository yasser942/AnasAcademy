...
Route::middleware([
    ...
    Route::prefix('plan')->controller(PlanController::class)->group(function () {
        Route::middleware('checkRole:أدمن')->group(function () {
    ...
    Route::prefix('curriculum')->controller(CurriculumController::class)->group(function () {
        ...
        Route::middleware('checkRole:أدمن')->group(function () {
            ...
            Route::post('/store', 'store')->name('curriculum.store')->middleware('checkRole:أدمن');
            Route::get('/edit/{id}', 'edit')->name('curriculum.edit')->middleware('checkRole:أدمن');
            Route::put('/update/{id}', 'update')->name('curriculum.update')->middleware('checkRole:أدمن');
            Route::delete('/delete/{id}', 'destroy')->name('curriculum.delete')->middleware('checkRole:أدمن');
        });
    ...
    Route::get('exam-question/{id}',[ExamQuestionController::class,'create'])->name('exam-question.create')->middleware('checkRole:أدمن');


    Route::get('question/{id}',[QuestionController::class,'create'])->name('question.create')->middleware('checkRole:أدمن');
