...
@section('content')
    ...
    <div class="card-body pt-0">
        <form  method="POST" action="{{route('practical-exam.update',$exam->id)}}">
            @csrf
            @method('PUT')
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="exampleInputEmail1" placeholder="رابط الامتحان" name="link" value="{{$exam->link}}">
            </div>
            <div class="form-group">
