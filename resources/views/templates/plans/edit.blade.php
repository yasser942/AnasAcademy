        ...
        <form  method="POST" action="{{route('plan.update',$plan->id)}}">
            ...
            @method('PUT')
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="اسم الخطة" name="name" value="{{$plan->name}}">
                </div>
            <div class="form-group">
                <label for="price">السعر</label>
                <input type="number" class="form-control" id="price" placeholder="السعر" name="price" value="{{$plan->price}}">
            </div>
            <div class="form-group">
                <label for="duration_in_days">المدة بالأيام</label>
                <input type="number" class="form-control" id="duration_in_days" placeholder="المدة بالأيام" name="duration_in_days" value="{{$plan->duration_in_days}}">
            </div>
                <div class="form-group">
